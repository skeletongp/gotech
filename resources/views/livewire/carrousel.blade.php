<div class=" w-full bg-gray-900 xl:py-4 relative bg-cover" style="background-image: url('https://res.cloudinary.com/dboafhu31/image/upload/v1623866886/bright-4357415_960_720_dfeeeu.jpg')">
    <div class="relative flex justify-between" >

        <div class="w-full xl:flex items-end justify-center text-white px-4 bg-cover w-1/2 border-l-8 border-gray-900">
            <h1
                class="uppercase xl:text-7xl text-center  xl:mt-1 py-4 text-white mb-2 px-4 font-bold shadow-lg rounded-xl">
                Domina las tecnologías, capacítate y aprende.</h1>
        </div>
